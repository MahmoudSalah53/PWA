 ...
 */
var _a;
const t$2 = globalThis, e$3 = t$2.ShadowRoot && (void 0 === t$2.ShadyCSS || t$2.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, s$2 = Symbol(), o$5 = /* @__PURE__ */ new WeakMap();
let n$3 = class n {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: i$2, defineProperty: e$2, getOwnPropertyDescriptor: h$2, getOwnPropertyNames: r$4, getOwnPropertySymbols: o$4, getPrototypeOf: n$2 } = Object, a$1 = globalThis, c$1 = a$1.trustedTypes, l$1 = c$1 ? c$1.emptyScript : "", p$1 = a$1.reactiveElementPolyfillSupport, d$1 = (t2, s2) => t2, u$1 = { toAttribute(t2, s2) {
  switch (s2) {
    case Boolean:
      t2 = t2 ? l$1 : null;
      break;
...
const V = (t2, i2) => {
  ...
  for (let i3 = 0; i3 < s2; i3++) {
    const s3 = t2[i3];
    let a2, u2, d2 = -1, y3 = 0;
    for (; y3 < s3.length && (c2.lastIndex = y3, u2 = c2.exec(s3), null !== u2); ) y3 = c2.lastIndex, c2 === f ? "!--" === u2[1] ? c2 = v : void 0 !== u2[1] ? c2 = _$1 : void 0 !== u2[2] ? ($.test(u2[2]) && (r2 = RegExp("</" + u2[2], "g")), c2 = m) : void 0 !== u2[3] && (c2 = m) : c2 === m ? ">" === u2[0] ? (c2 = r2 ?? f, d2 = -1) : void 0 === u2[1] ? d2 = -2 : (d2 = c2.lastIndex - u2[2].length, a2 = u2[1], c2 = void 0 === u2[3] ? m : '"' === u2[3] ? g : p) : c2 === g || c2 === p ? c2 = m : c2 === v || c2 === _$1 ? c2 = f : (c2 = m, r2 = void 0);
    const x2 = c2 === m && t2[i3 + 1].startsWith("/>") ? " " : "";
    l2 += c2 === f ? s3 + n$1 : d2 >= 0 ? (o2.push(a2), s3.slice(0, d2) + e$1 + s3.slice(d2) + h$1 + x2) : s3 + h$1 + (-2 === d2 ? i3 : x2);
  }
...
function _mergeNamespaces$1(n3, m2) {
...
function requireEvents() {
  ...
  function arrayClone(arr, n3) {
    ...
    for (var i2 = 0; i2 < n3; ++i2) copy[i2] = arr[i2];
    return copy;
  }
...
function asEncryptablePacket(packet) {
  var _a2, _b, _c, _d, _e;
  if (((_a2 = packet.value) === null || _a2 === void 0 ? void 0 : _a2.case) !== "sipDtmf" && ((_b = packet.value) === null || _b === void 0 ? void 0 : _b.case) !== "metrics" && ((_c = packet.value) === null || _c === void 0 ? void 0 : _c.case) !== "speaker" && ((_d = packet.value) === null || _d === void 0 ? void 0 : _d.case) !== "transcription" && ((_e = packet.value) === null || _e === void 0 ? void 0 : _e.case) !== "encryptedPacket") {
...
function isMobile() {
  ...
  return (
    ...
    (_b = (_a2 = navigator.userAgentData) === null || _a2 === void 0 ? void 0 : _a2.mobile) !== null && _b !== void 0 ? _b : /Tablet|iPad|Mobile|Android|BlackBerry/.test(navigator.userAgent)
  );
}
...
class SignalClient {
  ...
  get logContext() {
    var _a2, _b;
    return (_b = (_a2 = this.loggerContextCb) === null || _a2 === void 0 ? void 0 : _a2.call(this)) !== null && _b !== void 0 ? _b : {};
  }
...
function r(r2, e2, n3) {
  ...
  var a2 = null != (i2 = n3.isImmediate) && i2, u2 = null != (t2 = n3.callback) && t2, c2 = n3.maxWait, v2 = Date.now(), l2 = [];
  function f2() {
    if (void 0 !== c2) {
      var r3 = Date.now() - v2;
...
class PCTransport extends eventsExports.EventEmitter {
  ...
  get logContext() {
    var _a2, _b;
    return Object.assign({}, (_b = (_a2 = this.loggerOptions).loggerContextCb) === null || _b === void 0 ? void 0 : _b.call(_a2));
  }
  get isICEConnected() {
  ...
  getConnectionState() {
    var _a2, _b;
    return (_b = (_a2 = this._pc) === null || _a2 === void 0 ? void 0 : _a2.connectionState) !== null && _b !== void 0 ? _b : "closed";
  }
  getICEConnectionState() {
    var _a2, _b;
    return (_b = (_a2 = this._pc) === null || _a2 === void 0 ? void 0 : _a2.iceConnectionState) !== null && _b !== void 0 ? _b : "closed";
  }
  getSignallingState() {
    var _a2, _b;
    return (_b = (_a2 = this._pc) === null || _a2 === void 0 ? void 0 : _a2.signalingState) !== null && _b !== void 0 ? _b : "closed";
  }
  getTransceivers() {
    var _a2, _b;
    return (_b = (_a2 = this._pc) === null || _a2 === void 0 ? void 0 : _a2.getTransceivers()) !== null && _b !== void 0 ? _b : [];
  }
  getSenders() {
    var _a2, _b;
    return (_b = (_a2 = this._pc) === null || _a2 === void 0 ? void 0 : _a2.getSenders()) !== null && _b !== void 0 ? _b : [];
  }
  getLocalDescription() {
    var _a2;
  ...
  constructor(rtcConfig, mode, loggerOptions) {
    ...
    this.updateState = () => {
      ...
      if (previousState !== this.state) {
        ...
        (_a3 = this.onStateChange) === null || _a3 === void 0 ? void 0 : _a3.call(this, this.state, this.publisher.getConnectionState(), (_b = this.subscriber) === null || _b === void 0 ? void 0 : _b.getConnectionState());
      }
    };
...
class LocalTrack extends Track {
  ...
  get mediaStreamTrack() {
    var _a2, _b;
    return (_b = (_a2 = this.processor) === null || _a2 === void 0 ? void 0 : _a2.processedTrack) !== null && _b !== void 0 ? _b : this._mediaStreamTrack;
  }
  get isLocal() {
    return true;
  }
...
const computeDefaultScreenShareSimulcastPresets = (fromPreset) => {
  ...
  return layers.map((t2) => {
    var _a2, _b;
    return new VideoPreset(Math.floor(fromPreset.width / t2.scaleResolutionDownBy), Math.floor(fromPreset.height / t2.scaleResolutionDownBy), Math.max(15e4, Math.floor(fromPreset.encoding.maxBitrate / (Math.pow(t2.scaleResolutionDownBy, 2) * (((_a2 = fromPreset.encoding.maxFramerate) !== null && _a2 !== void 0 ? _a2 : 30) / ((_b = t2.fps) !== null && _b !== void 0 ? _b : 30))))), t2.fps, fromPreset.encoding.priority);
  });
};
...
class LocalVideoTrack extends LocalTrack {
  ...
  getSenderStats() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      items.sort((a2, b2) => {
        var _a3, _b;
        return ((_a3 = b2.frameWidth) !== null && _a3 !== void 0 ? _a3 : 0) - ((_b = a2.frameWidth) !== null && _b !== void 0 ? _b : 0);
      });
      return items;
    });
  }
      ...
      return function* () {
        ...
        if ((_d = _this.processor) === null || _d === void 0 ? void 0 : _d.processedTrack) {
          try {
            ...
            try {
              if (!_f && !_a2 && (_b = _g.return)) yield _b.call(_g);
            } finally {
  ...
  setPublishingCodecs(codecs) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const newCodecs = [];
      try {
        for (_a2 = true, codecs_1 = __asyncValues(codecs); codecs_1_1 = yield codecs_1.next(), _b = codecs_1_1.done, !_b; _a2 = true) {
          _d = codecs_1_1.value;
          _a2 = false;
          const codec = _d;
        ...
        try {
          if (!_a2 && !_b && (_c = codecs_1.return)) yield _c.call(codecs_1);
        } finally {
...
class RTCEngine extends eventsExports.EventEmitter {
  ...
  get logContext() {
    var _a2, _b, _c, _d, _e, _f;
    return {
      room: (_b = (_a2 = this.latestJoinResponse) === null || _a2 === void 0 ? void 0 : _a2.room) === null || _b === void 0 ? void 0 : _b.name,
    ...
    return __awaiter(this, arguments, void 0, function(kind) {
      ...
      return function* () {
        ...
        while ((/* @__PURE__ */ new Date()).getTime() < endTime) {
          if (transport.isICEConnected && ((_a2 = _this2.dataChannelForKind(kind, subscriber)) === null || _a2 === void 0 ? void 0 : _a2.readyState) === "open") {
            return;
          }
          yield sleep(50);
        }
      ...
      next: () => __awaiter(this, void 0, void 0, function* () {
        ...
        try {
          const {
            ...
            (_b = (_a2 = this.outOfBandFailureRejectingFuture) === null || _a2 === void 0 ? void 0 : _a2.promise) !== null && _b !== void 0 ? _b : new Promise(() => {
            })
          ]);
          if (done) {
    ...
    return __awaiter(this, arguments, void 0, function() {
      ...
      return function* () {
        ...
        try {
          ...
          try {
            if (!_d && !_a2 && (_b = iterator_1.return)) yield _b.call(iterator_1);
          } finally {
            if (e_1) throw e_1.error;
          }
        }
    ...
    return __awaiter(this, arguments, void 0, function() {
      ...
      return function* () {
        ...
        try {
          ...
          try {
            if (!_d && !_a2 && (_b = iterator_2.return)) yield _b.call(iterator_2);
          } finally {
            if (e_2) throw e_2.error;
          }
        }
  ...
  validateParticipantHasNoActiveDataStreams(participantIdentity) {
    ...
    if (textStreamsBeingSentByDisconnectingParticipant.length > 0 || byteStreamsBeingSentByDisconnectingParticipant.length > 0) {
      ...
      for (const [id, controller] of byteStreamsBeingSentByDisconnectingParticipant) {
        (_b = (_a2 = controller.outOfBandFailureRejectingFuture).reject) === null || _b === void 0 ? void 0 : _b.call(_a2, abnormalEndError);
...
class HTMLElementInfo {
  ...
  constructor(element, visible) {
    ...
    this.onEnterPiP = () => {
      var _a2, _b, _c;
      (_b = (_a2 = window.documentPictureInPicture) === null || _a2 === void 0 ? void 0 : _a2.window) === null || _b === void 0 ? void 0 : _b.addEventListener("pagehide", this.onLeavePiP);
      this.isPiP = isElementInPiP(this.element);
...
function isElementInPiP(el) {
  ...
  if ((_a2 = window.documentPictureInPicture) === null || _a2 === void 0 ? void 0 : _a2.window) return isElementInViewport(el, (_b = window.documentPictureInPicture) === null || _b === void 0 ? void 0 : _b.window);
  return false;
}
...
class Participant extends eventsExports.EventEmitter {
  get logContext() {
    var _a2, _b;
    return Object.assign({}, (_b = (_a2 = this.loggerOptions) === null || _a2 === void 0 ? void 0 : _a2.loggerContextCb) === null || _b === void 0 ? void 0 : _b.call(_a2));
  }
  get isEncrypted() {
  ...
  waitUntilActive() {
    ...
    this.once(ParticipantEvent.Active, () => {
      var _a2, _b;
      (_b = (_a2 = this.activeFuture) === null || _a2 === void 0 ? void 0 : _a2.resolve) === null || _b === void 0 ? void 0 : _b.call(_a2);
  ...
  setPermissions(permissions) {
    ...
    const changed = permissions.canPublish !== ((_a2 = this.permissions) === null || _a2 === void 0 ? void 0 : _a2.canPublish) || permissions.canSubscribe !== ((_b = this.permissions) === null || _b === void 0 ? void 0 : _b.canSubscribe) || permissions.canPublishData !== ((_c = this.permissions) === null || _c === void 0 ? void 0 : _c.canPublishData) || permissions.hidden !== ((_d = this.permissions) === null || _d === void 0 ? void 0 : _d.hidden) || permissions.recorder !== ((_e = this.permissions) === null || _e === void 0 ? void 0 : _e.recorder) || permissions.canPublishSources.length !== this.permissions.canPublishSources.length || permissions.canPublishSources.some((value, index) => {
      var _a3;
  ...
  setDisconnected() {
    var _a2, _b;
    if (this.activeFuture) {
      (_b = (_a2 = this.activeFuture).reject) === null || _b === void 0 ? void 0 : _b.call(_a2, new Error("Participant disconnected"));
      this.activeFuture = void 0;
    }
  }
  /**
...
class LocalParticipant extends Participant {
  ...
  constructor(sid, identity, engine, options, roomRpcHandlers, roomOutgoingDataStreamManager) {
    ...
    this.handleClosing = () => {
      ...
      if (this.reconnectFuture) {
        ...
        (_b = (_a2 = this.reconnectFuture) === null || _a2 === void 0 ? void 0 : _a2.reject) === null || _b === void 0 ? void 0 : _b.call(_a2, "Got disconnected during reconnection attempt");
        this.reconnectFuture = void 0;
      }
    ...
    this.handleSignalConnected = (joinResponse) => {
      ...
      (_b = (_a2 = this.signalConnectedFuture).resolve) === null || _b === void 0 ? void 0 : _b.call(_a2);
    };
    ...
    this.handleSubscribedQualityUpdate = (update) => __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        try {
          if (!_e && !_a2 && (_b = newCodecs_1.return)) yield _b.call(newCodecs_1);
        } finally {
          if (e_1) throw e_1.error;
        }
      }
      ...
      return function* () {
        return new Promise((resolve, reject) => __awaiter(_this, void 0, void 0, function* () {
          ...
          try {
            ...
            const requestId = yield this.engine.client.sendUpdateLocalMetadata((_a3 = metadata !== null && metadata !== void 0 ? metadata : this.metadata) !== null && _a3 !== void 0 ? _a3 : "", (_b = name !== null && name !== void 0 ? name : this.name) !== null && _b !== void 0 ? _b : "", attributes);
  ...
  createTracks(options) {
    return __awaiter(this, void 0, void 0, function* () {
      var _a2, _b;
      options !== null && options !== void 0 ? options : options = {};
      const mergedOptionsWithProcessors = mergeDefaultOptions(options, (_a2 = this.roomOptions) === null || _a2 === void 0 ? void 0 : _a2.audioCaptureDefaults, (_b = this.roomOptions) === null || _b === void 0 ? void 0 : _b.videoCaptureDefaults);
      try {
          ...
          const bufferStreamPromise = new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
              ...
              try {
                ...
                try {
                  if (!_f2 && !_a3 && (_b2 = stream_1.return)) yield _b2.call(stream_1);
                } finally {
                  if (e_2) throw e_2.error;
                }
              }
    ...
    return __awaiter(this, arguments, void 0, function(_ref3) {
      ...
      return function* () {
        ...
        return new Promise((resolve, reject) => __awaiter(_this5, void 0, void 0, function* () {
          ...
          if (((_b = (_a3 = this.engine.latestJoinResponse) === null || _a3 === void 0 ? void 0 : _a3.serverInfo) === null || _b === void 0 ? void 0 : _b.version) && compareVersions((_d = (_c = this.engine.latestJoinResponse) === null || _c === void 0 ? void 0 : _c.serverInfo) === null || _d === void 0 ? void 0 : _d.version, "1.8.0") < 0) {
  ...
  setActiveAgent(agent) {
    ...
    if (agent) {
      (_b = (_a2 = this.activeAgentFuture) === null || _a2 === void 0 ? void 0 : _a2.resolve) === null || _b === void 0 ? void 0 : _b.call(_a2, agent);
    } else {
...
class RemoteTrackPublication extends TrackPublication {
  ...
  setVideoDimensions(dimensions) {
    ...
    if (((_a2 = this.requestedVideoDimensions) === null || _a2 === void 0 ? void 0 : _a2.width) === dimensions.width && ((_b = this.requestedVideoDimensions) === null || _b === void 0 ? void 0 : _b.height) === dimensions.height) {
      return;
    }
...
class Room extends eventsExports.EventEmitter {
  ...
  constructor(options) {
    ...
    this.connect = (url, token, opts) => __awaiter(this, void 0, void 0, function* () {
      ...
      if (((_a3 = this.regionUrlProvider) === null || _a3 === void 0 ? void 0 : _a3.getServerUrl().toString()) !== url) {
  ...
  get isRecording() {
    var _a2, _b;
    return (_b = (_a2 = this.roomInfo) === null || _a2 === void 0 ? void 0 : _a2.activeRecording) !== null && _b !== void 0 ? _b : false;
  }
  /**
  ...
  get name() {
    var _a2, _b;
    return (_b = (_a2 = this.roomInfo) === null || _a2 === void 0 ? void 0 : _a2.name) !== null && _b !== void 0 ? _b : "";
  }
  /** room metadata */
  get metadata() {
    var _a2;
  ...
  get numParticipants() {
    var _a2, _b;
    return (_b = (_a2 = this.roomInfo) === null || _a2 === void 0 ? void 0 : _a2.numParticipants) !== null && _b !== void 0 ? _b : 0;
  }
  get numPublishers() {
    var _a2, _b;
    return (_b = (_a2 = this.roomInfo) === null || _a2 === void 0 ? void 0 : _a2.numPublishers) !== null && _b !== void 0 ? _b : 0;
  }
  maybeCreateEngine() {
    if (this.engine && !this.engine.isClosed) {
      return;
      ...
      return function* () {
        ...
        if (kind === "audioinput") {
          ...
          const isMuted = tracks.some((t2) => {
            var _a3, _b2;
            return (_b2 = (_a3 = t2.track) === null || _a3 === void 0 ? void 0 : _a3.isMuted) !== null && _b2 !== void 0 ? _b2 : false;
          });
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (publishOptions.video) {
        const camPub = new LocalTrackPublication(Track.Kind.Video, new TrackInfo({
          ...
          video: true
        })).getVideoTracks()[0] : createDummyVideoStreamTrack(160 * ((_a2 = participantOptions.aspectRatios[0]) !== null && _a2 !== void 0 ? _a2 : 1), 160, true, true), void 0, false, {
          loggerName: this.options.loggerName,
          loggerContextCb: () => this.logContext
        }), {
          loggerName: this.options.loggerName,
      ...
      yield new Promise((resolve) => {
        video.onplay = () => {
          setTimeout(() => {
            ...
            const width = (_b = (_a2 = settings.width) !== null && _a2 !== void 0 ? _a2 : video.videoWidth) !== null && _b !== void 0 ? _b : 1280;
...
class TURNCheck extends Checker {
  ...
  perform() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (((_b = (_a2 = this.connectOptions) === null || _a2 === void 0 ? void 0 : _a2.rtcConfig) === null || _b === void 0 ? void 0 : _b.iceServers) || hasTURN) {
...
class WebSocketCheck extends Checker {
  ...
  perform() {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (((_a2 = joinRes.serverInfo) === null || _a2 === void 0 ? void 0 : _a2.edition) === ServerInfo_Edition.Cloud && ((_b = joinRes.serverInfo) === null || _b === void 0 ? void 0 : _b.region)) {
...
class AudioMeter {
  constructor(callback) {
    ...
    this.tick = () => {
      ...
      for (let i2 = 0; i2 < data.length; i2++) {
        const normalized = (data[i2] - 128) / 128;
  ...
  start(stream) {
    ...
    try {
      ...
      console.error("Failed to create audio stream source:", e2);
      return;
    }
    this.tick();
  }
  stop() {
    ...
    try {
      ...
      console.error("Error disconnecting audio meter:", e2);
    }
    this.smoothed = 0;
    this.lastUpdate = 0;
    this.callback(0);
...
let VoiceAgentComponent = class extends i {
  constructor() {
    super();
    this.backendUrl = "http://148.230.125.200:9060";
    this.livekitUrl = "wss://ecommerce-sgjr7auj.livekit.cloud";
    this.tokenEndpoint = "/api/voice/getToken";
    ...
    this.token = null;
    this.roomName = null;
    this.audioMeter = new AudioMeter((level) => {
  ...
  async handleSearch(payload) {
    try {
      ...
      if (query && !category) {
        ...
        if (product && product.id) {
          const route2 = `/services/${product.id}`;
  ...
  async handleProductSearch(payload) {
    try {
  ...
  async connectToLiveKit(connectionToken, connectionRoom) {
    ...
    try {
      ...
      room.on(RoomEvent.Connected, () => {
        ...
        room.localParticipant.registerRpcMethod("client.navigate", async (data) => {
          const payload = JSON.parse(data.payload);
          const result = await this.handleNavigation(payload);
          return JSON.stringify(result);
        });
        room.localParticipant.registerRpcMethod("client.search", async (data) => {
          const payload = JSON.parse(data.payload);
          const result = await this.handleSearch(payload);
          return JSON.stringify(result);
        });
        room.localParticipant.registerRpcMethod("client.searchProduct", async (data) => {
          const payload = JSON.parse(data.payload);
          const result = await this.handleProductSearch(payload);
          return JSON.stringify(result);
        });
        room.localParticipant.registerRpcMethod("client.filter", async (data) => {
          const payload = JSON.parse(data.payload);
      ...
      room.on(RoomEvent.TrackSubscribed, (track) => {
        if (track.kind === "audio") {
          ...
          try {
            ...
            console.error("Failed to capture agent audio stream:", e2);
          }
        }
      });
  ...
  renderSiriPulseCircle(level, isSpeaking, isStatic) {
    const layer1Speed = 8;
    ...
    const sphereDropShadow = isStatic ? 20 : isSpeaking && level > 0.1 ? 20 + level * 40 : 20;
  ...
  render() {
    return x`
      ...
      this.showTestButtons = !this.showTestButtons;
        ...
        >
          ${this._isConnecting ? x`<div class="spinner"></div>` : this._isConnected ? this.renderSiriPulseCircle(this.audioLevel, this.isAgentSpeaking, false) : this.renderSiriPulseCircle(0, false, true)}
        </button>
...
VoiceAgentComponent.styles = i$3`
    :host {
      display: block;
      position: fixed;
      bottom: 24px;
  ...
  `;
__decorateClass([
  n2({ type: String, attribute: "backend-url" })
], VoiceAgentComponent.prototype, "backendUrl", 2);
__decorateClass([
  n2({ type: String, attribute: "livekit-url" })
], VoiceAgentComponent.prototype, "livekitUrl", 2);
__decorateClass([
  n2({ type: String, attribute: "token-endpoint" })
], VoiceAgentComponent.prototype, "tokenEndpoint", 2);
__decorateClass([
  n2({ type: Boolean, attribute: "show-test-buttons" })
], VoiceAgentComponent.prototype, "showTestButtons", 2);
__decorateClass([
  r$1()
], VoiceAgentComponent.prototype, "_isConnected", 2);
__decorateClass([
  r$1()
], VoiceAgentComponent.prototype, "_isConnecting", 2);
__decorateClass([
  r$1()
], VoiceAgentComponent.prototype, "currentCommand", 2);
__decorateClass([
  r$1()
], VoiceAgentComponent.prototype, "isAgentSpeaking", 2);
__decorateClass([
  r$1()
], VoiceAgentComponent.prototype, "audioLevel", 2);
VoiceAgentComponent = __decorateClass([
  t("voice-agent")
], VoiceAgentComponent);
export {
  VoiceAgentComponent
};
//# sourceMappingURL=voice-agent.mjs.map
